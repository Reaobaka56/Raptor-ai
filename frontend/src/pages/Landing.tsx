...
const faqs = [
  {
    ...
    a: 'Under 60 seconds. Connect your GitHub account, install Raptor on a repo, and your first PR review will be waiting the next time a PR is opened.',
  },
  {
    q: 'Does it work on private repositories?',
    a: 'Yes. Raptor works on both public and private repositories. Code is never stored — only the diff is analysed and discarded after review.',
  },
  {
    q: 'What languages does Raptor support?',
    a: 'Raptor supports all major languages including TypeScript, Python, Go, Java, Rust, Ruby, and more. Language detection is automatic.',
  },
  {
    q: 'How is this different from GitHub Copilot?',
    a: "Copilot helps you write code. Raptor reviews code after it's written — catching security issues, performance regressions, and convention violations that Copilot doesn't flag.",
  },
  {
    q: 'What does "team memory" mean?',
    a: "After 10 PRs, Raptor learns your team's specific conventions and suppresses rules that don't apply to your codebase — reducing false positives to near zero.",
  },
  {
    q: 'Is there a free plan?',
    a: 'Yes. Raptor is free for up to 5 repositories and 100 PRs per month. Open source projects get unlimited reviews for free.',
  },
];
  ...
  const handleGithubLogin = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${apiBaseUrl}/api/auth/github/login?redirectUri=${encodeURIComponent(
          redirectUri
        )}`,
        {
          credentials: 'include',
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="px-4 md:px-12 pb-32 max-w-5xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-16">
          From PR open to reviewed in seconds.
        </h2>
        ...
        <div className="grid gap-12 md:grid-cols-3">
          {[
            ...
            },
            {
              n: '02',
              icon: Zap,
              title: 'PR opens → review starts',
              desc: 'The moment a PR is opened, Raptor analyses the diff for security vulnerabilities, performance regressions, and convention violations.',
            },
            {
              n: '03',
              icon: GitPullRequest,
      ...
      <section className="px-4 md:px-12 pb-32 max-w-5xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-16">
          Every category of issue. Automatically.
        </h2>
          ...
          {[
            {
              ...
              desc: 'SQL injections, XSS, secrets in code, broken authentication, missing rate limits — caught before they reach production.',
            },
            {
              icon: Zap,
              title: 'Performance regressions',
              desc: 'N+1 queries, missing indexes, unoptimised loops, memory leaks — identified with specific line numbers and fixes.',
            },
            {
              icon: Users,
      ...
      <section className="px-4 md:px-12 pb-32 max-w-4xl mx-auto">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {[
            {
              quote:
                'Raptor caught a SQL injection in our auth service that had been in production for 6 months. The fix PR was ready before I finished reading the alert.',
              name: 'Engineering Lead',
              company: 'FinTech startup, Cape Town',
            },
            {
              quote:
                'We went from 45-minute PR reviews to 3 minutes. The team now ships twice as fast and we have fewer bugs in production.',
              name: 'CTO',
      ...
      <section className="px-4 md:px-12 pb-32 text-center">
        ...
        <p className="mt-6 text-gray-400 max-w-md mx-auto">
          Try Raptor on your next pull request today.
        </p>
        ...
        <p className="mt-4 text-xs text-gray-700">
          Free for open source · No credit card · Cancel anytime
        </p>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start justify-between gap-8">
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-600 max-w-xs">
              AI code review for engineering teams. Built in Cape Town,
              South Africa.
            </p>
