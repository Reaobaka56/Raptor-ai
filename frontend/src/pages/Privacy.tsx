    ...
    <div className="min-h-screen bg-black text-gray-300 font-sans selection:bg-white/20 selection:text-white pb-24">
      ...
      <nav className="border-b border-white/10 bg-black sticky top-0 z-50 backdrop-blur-xl bg-black/80 px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-bold tracking-tight text-lg">Raptor Privacy</span>
        </div>
      ...
      <main className="max-w-3xl mx-auto px-6 pt-16 font-sans">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-gray-400">
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight">1. Zero Code Retention</h2>
            <p>
              We maintain absolute privacy. Code diffs analyzed by Raptor are processed entirely in memory. Once the analysis review is posted back to GitHub, all diff data is wiped. No code is ever used to train AI models.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              We collect minimal metadata: GitHub usernames, repository names, pull request URLs, and webhook execution timestamps strictly for operational analytics and rate-limiting.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight">3. Security Standards</h2>
            <p>
              All transit traffic is secured using TLS 1.3 encryption. We strictly comply with SOC2 Type II and GDPR data protection frameworks.
            </p>
          </section>
        </div>
      </main>
